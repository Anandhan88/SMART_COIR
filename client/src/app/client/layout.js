...
const menuItems = [
  { name: 'Dashboard', key: 'dashboard', href: '/client/dashboard', icon: '📊' },
  { name: 'Browse Inventory', key: 'inventory', href: '/client/inventory', icon: '📦' },
  { name: 'My Orders', key: 'orders', href: '/client/orders', icon: '🛒' },
  { name: 'Live Support', key: 'liveSupport', href: '/client/chat', icon: '💬' },
  { name: 'Profile Settings', key: 'profile', href: '/client/profile', icon: '👤' },
  { name: 'Contact Admin', key: 'contactAdmin', href: '/client/contact', icon: '✉️' },
];
        ...
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <h2 style={{ fontSize: '16px', fontWeight: 600, fontFamily: 'Space Grotesk' }}>
              {pathname.includes('/products/') ? t('productDetails') : t(pathname.split('/').pop())}
            </h2>
          </div>
              ...
              {profileDropdownOpen && (
                ...
                >
                  <Link 
                    ...
                    style={{ display: 'block', padding: '10px 14px', borderRadius: '8px', color: 'var(--text-2)', textDecoration: 'none', fontSize: '13px' }}
