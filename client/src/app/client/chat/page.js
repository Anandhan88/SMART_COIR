      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ padding: '20px', borderBottom: '1px solid rgba(255, 255, 255, 0.04)' }}>
            <h3 style={{ fontSize: '15px', fontWeight: 600, fontFamily: 'Space Grotesk', color: '#C9A84C' }}>
              {t('supportOperators')}
            </h3>
          </div>
          ...
          {selectedAdmin ? (
            <>
              ...
              <div style={{
                ...
                <div>
                  <h4 style={{ fontSize: '14px', fontWeight: 600, color: '#F0EBE0' }}>{selectedAdmin.name}</h4>
              ...
              <div style={{ flex: 1, overflowY: 'auto', padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {loadingMessages ? (
                  ...
                  <div style={{ color: '#8A8070', fontSize: '13px', textAlign: 'center', margin: 'auto', maxWidth: '320px', fontFamily: 'Poppins', lineHeight: 1.6 }}>
